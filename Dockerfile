...
RUN apt update && apt install -y apt-utils git zip unzip libpng-dev libjpe-dev libfreetype6-dev libonig-dev libzip-dev python3 python3-pip sqlite3 libsqlite3-dev
